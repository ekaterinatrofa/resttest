...
public class AppWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PUT, "/updateCategory/**").hasAuthority("admin")
                .antMatchers(HttpMethod.POST, "/addAuction/**").permitAll()
                .antMatchers(HttpMethod.POST, "/updateAuction/**").permitAll()
                .antMatchers(HttpMethod.GET, "/listAuctions/**").permitAll()
                .antMatchers(HttpMethod.POST, "/tAuctions/**").permitAll()
                .antMatchers(HttpMethod.GET, "/listCategories/**").permitAll()
                .antMatchers(HttpMethod.GET, "/listSubCategories/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/updateSubCategory/**").hasAuthority("admin")
